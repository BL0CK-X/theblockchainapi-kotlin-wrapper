...
> kotlin.collections.List&lt;CandyMachineSearchResponse&gt; solanaSearchCandyMachines(candyMachineSearchRequest)
...
try {
    val result : kotlin.collections.List<CandyMachineSearchResponse> = apiInstance.solanaSearchCandyMachines(candyMachineSearchRequest)
    println(result)
} catch (e: ClientException) {
...
[**kotlin.collections.List&lt;CandyMachineSearchResponse&gt;**](CandyMachineSearchResponse.md)
