...
**amount** | **kotlin.String** | The quantity of the token or NFT you want to send. If sending an NFT, there is no need to supply this value.  This value must be a string. You can supply a float value (e.g., \&quot;0.0005\&quot;).  |  [optional]
