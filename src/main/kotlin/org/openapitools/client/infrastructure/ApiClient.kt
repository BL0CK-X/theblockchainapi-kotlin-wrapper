...
open class ApiClient(val baseUrl: String) {
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
        if (requestConfig.headers["APIKeyID"].isNullOrEmpty()) {
            if (apiKey["APIKeyID"] != null) {
                if (apiKeyPrefix["APIKeyID"] != null) {
                    requestConfig.headers["APIKeyID"] = apiKeyPrefix["APIKeyID"]!! + " " + apiKey["APIKeyID"]!!
                } else {
                    requestConfig.headers["APIKeyID"] = apiKey["APIKeyID"]!!
                }
            }
        }
        if (requestConfig.headers["APISecretKey"].isNullOrEmpty()) {
            if (apiKey["APISecretKey"] != null) {
                if (apiKeyPrefix["APISecretKey"] != null) {
                    requestConfig.headers["APISecretKey"] = apiKeyPrefix["APISecretKey"]!! + " " + apiKey["APISecretKey"]!!
                } else {
                    requestConfig.headers["APISecretKey"] = apiKey["APISecretKey"]!!
                }
            }
        }
    }
