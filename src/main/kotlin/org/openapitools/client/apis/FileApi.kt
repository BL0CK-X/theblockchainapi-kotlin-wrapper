...
import org.openapitools.client.models.GetFileResponse
...
class FileApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun uploadFile() : GetFileResponse {
        val localVariableConfig = uploadFileRequestConfig()

        val localVarResponse = request<Unit, GetFileResponse>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetFileResponse
    ...
    */
    fun uploadFileRequestConfig() : RequestConfig<Unit> {
