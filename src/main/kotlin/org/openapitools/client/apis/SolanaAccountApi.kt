...
class SolanaAccountApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    fun solanaGetAccountRequestConfig(network: kotlin.String, publicKey: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/solana/account/{network}/{public_key}".replace("{"+"network"+"}", "$network").replace("{"+"public_key"+"}", "$publicKey"),
    ...
    * @return RequestConfig
    */
    fun solanaGetAccountIsCandyMachineRequestConfig(network: kotlin.String, publicKey: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/solana/account/{network}/{public_key}/is_candy_machine".replace("{"+"network"+"}", "$network").replace("{"+"public_key"+"}", "$publicKey"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    * @return RequestConfig
    */
    fun solanaGetAccountIsNFTRequestConfig(network: kotlin.String, publicKey: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/solana/account/{network}/{public_key}/is_nft".replace("{"+"network"+"}", "$network").replace("{"+"public_key"+"}", "$publicKey"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
