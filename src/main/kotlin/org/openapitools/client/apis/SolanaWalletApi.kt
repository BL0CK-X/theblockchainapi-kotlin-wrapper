...
class SolanaWalletApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun solanaGetTokensBelongingToWallet(network: kotlin.String, publicKey: kotlin.String) : kotlin.collections.List<kotlin.Any> {
        val localVariableConfig = solanaGetTokensBelongingToWalletRequestConfig(network = network, publicKey = publicKey)
    ...
    * @return RequestConfig
    */
    fun solanaGetTokensBelongingToWalletRequestConfig(network: kotlin.String, publicKey: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
