...
class SolanaTransactionApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    fun solanaGetTransactionRequestConfig(network: kotlin.String, txSignature: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/solana/transaction/{network}/{tx_signature}".replace("{"+"network"+"}", "$network").replace("{"+"tx_signature"+"}", "$txSignature"),
