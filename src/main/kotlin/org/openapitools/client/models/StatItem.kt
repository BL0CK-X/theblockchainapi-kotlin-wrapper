 ...
 * 
 *
 * @param uid The anonymous ID of the user who called your endpoint 
 * @param timeStamp The time stamp of the ten-minute interval 
 * @param endpointId The full path of the endpoint (e.g., `project_id`/`version`/`path`) 
 * @param apiCalls The number of API calls by this user to this endpoint for the ten-minute interval 
 * @param version The version of the endpoint
 * @param path The path of the endpoint (not inclusive of the `version` or `project_id`)
 */
...
data class StatItem (
    ...
    @Json(name = "api_calls")
    val apiCalls: java.math.BigDecimal? = null,
