 ...
 *
 * @param idType What type of identifier you are collecting, either an \"email\" or \"misc\"ellanous. Miscellanous simply means you are collecting something other than an email.  
 * @param name The name of the customer ID input presented to the user 
 * @param description The description / stated purpose of the customer ID input presented to the user 
 * @param required Whether to require the customer ID 
 */

data class CCProjectCreateRequestCustomerIdToCollect (
    ...
    @Json(name = "id_type")
    val idType: CCProjectCreateRequestCustomerIdToCollect.IdType,
