 ...
 * 
 *
 * @param updateAuthority The public key of the update authority of the NFT
 * @param updateAuthoritySearchMethod Only `exact_match` supported at this time
 * @param mintAddress The mint address of the NFT
 * @param mintAddressSearchMethod Only `exact_match` supported at this time
 * @param name The name of the NFT
 * @param nameSearchMethod 
 * @param uri The NFT's uri
 * @param uriSearchMethod 
 * @param symbol The symbol associated with the candy machine
 * @param symbolSearchMethod 
 * @param network 
 */

data class NFTSearchRequest (
    ...
    val updateAuthoritySearchMethod: NFTSearchRequest.UpdateAuthoritySearchMethod? = UpdateAuthoritySearchMethod.exactMatch,
    ...
    /* Only `exact_match` supported at this time */
    @Json(name = "mint_address_search_method")
    val mintAddressSearchMethod: NFTSearchRequest.MintAddressSearchMethod? = MintAddressSearchMethod.exactMatch,

    /* The name of the NFT */
    @Json(name = "name")
    val name: kotlin.String? = null,

    @Json(name = "name_search_method")
    val nameSearchMethod: NFTSearchRequest.NameSearchMethod? = NameSearchMethod.exactMatch,

    /* The NFT's uri */
    @Json(name = "uri")
    val uri: kotlin.String? = null,

    @Json(name = "uri_search_method")
    val uriSearchMethod: NFTSearchRequest.UriSearchMethod? = UriSearchMethod.exactMatch,
    ...
    val symbolSearchMethod: NFTSearchRequest.SymbolSearchMethod? = SymbolSearchMethod.exactMatch,

    @Json(name = "network")
    val network: NFTSearchRequest.Network? = Network.devnet
     ...
     * Values: exactMatch
     */
    enum class MintAddressSearchMethod(val value: kotlin.String) {
        @Json(name = "exact_match") exactMatch("exact_match");
    }
    /**
     * 
     ...
     */
    enum class NameSearchMethod(val value: kotlin.String) {
     ...
     * Values: beginsWith,exactMatch
     */
    enum class UriSearchMethod(val value: kotlin.String) {
        @Json(name = "begins_with") beginsWith("begins_with"),
        @Json(name = "exact_match") exactMatch("exact_match");
    }
    /**
