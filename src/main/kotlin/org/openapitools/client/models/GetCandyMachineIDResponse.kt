 ...
 * 
 *
 * @param candyMachineId The ID of the candy machine that minted the NFT
...
data class GetCandyMachineIDResponse (
    ...
    val candyMachineContractVersion: GetCandyMachineIDResponse.CandyMachineContractVersion? = null
