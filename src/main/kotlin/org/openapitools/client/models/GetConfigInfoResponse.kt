...
import org.openapitools.client.models.GetConfigInfoResponseCreators
 ...
 * @param creators 
 * @param isMutable 
 * @param retainAuthority A public key address
 * @param sellerFeeBasisPoints The fee of each sale the creators receive. 100 basis points = 1%
 * @param symbol The symbol of the candy machine NFT colletion
 */

data class GetConfigInfoResponse (

    @Json(name = "authority")
    val authority: kotlin.String? = null,

    @Json(name = "creators")
    val creators: kotlin.collections.List<GetConfigInfoResponseCreators>? = null,
    ...
    val retainAuthority: kotlin.String? = null,
