 ...
 * 
 *
 * @param `data` More info about the account. What are included depends on the type of account. See examples.
 * @param executable Whether or not this account is marked as executable
...
data class AccountValue (
    ...
    @Json(name = "rent_epoch")
    val rentEpoch: java.math.BigDecimal? = null
