 ...
 * 
 *
 * @param balance The balance of the token in the wallet
 * @param network 
 * @param integerBalance Not included if retreiving SOL balance
 * @param decimals Not included if retreiving SOL balance. Sometimes not included if the balance of the token is '0'.
 * @param unit Not included if retreiving an SPL token/NFT balance
 */
...
data class BalanceResponse (
    ...
    @Json(name = "network")
    val network: BalanceResponse.Network,

    /* Not included if retreiving SOL balance */
    @Json(name = "integer_balance")
    val integerBalance: java.math.BigDecimal? = null,
    ...
    @Json(name = "unit")
    val unit: BalanceResponse.Unit? = null
