 ...
 * 
 *
 * @param candyMachineId The ID of the candy machine. This is the same as `config_address` for `v2` candy machines (supply either). 
 * @param configAddress The configuration address of the candy machine. This is the same as `candy_machine_id` for `v2` candy machines (supply either). 
 * @param uuid The uuid of the candy machine. This is an alphanumeric string of length six (e.g., HpVdfP), which corresponds to the first six characters of the config_address. 
 * @param network 
...
data class GetCandyMetadataRequest (
    ...
    @Json(name = "network")
    val network: GetCandyMetadataRequest.Network? = Network.devnet,
    ...
    val candyMachineContractVersion: GetCandyMetadataRequest.CandyMachineContractVersion? = CandyMachineContractVersion.v1
