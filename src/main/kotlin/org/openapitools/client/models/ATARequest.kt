 ...
 * @param tokenAddress The address of the token to get the ATA for. For an NFT, this is the same as `mint` (the mint address).
...
data class ATARequest (
    ...
    @Json(name = "network")
    val network: ATARequest.Network? = Network.devnet
