...
import org.openapitools.client.models.GetAllNFTsResponseMintedNfts
import org.openapitools.client.models.GetAllNFTsResponseUnmintedNfts
...
data class GetAllNFTsResponse (
    ...
    @Json(name = "minted_nfts")
    val mintedNfts: kotlin.collections.List<GetAllNFTsResponseMintedNfts>? = null,

    /* The unminted NFTs. Only filled in for `v1` candy machines. Left empty for `v2`. */
    @Json(name = "unminted_nfts")
    val unmintedNfts: kotlin.collections.List<GetAllNFTsResponseUnmintedNfts>? = null,
