 ...
 * 
 *
 * @param publicKey The public key address of the wallet
 * @param unit If you are retrieving the SOL balance, you can select whether to retrieve this in SOL or Lamport units (1 SOL = 1e9 Lamports).
 * @param network 
 * @param mintAddress The mint address of the SPL token. If not provided, the balance returned is in SOL. Make sure to use the correct network.  Some example mint addresses: - USDC: EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v - Mango: MangoCzJ36AjZyKwVj3VnYU4GTonjfVEnJmvvWaxLac - Serum: SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt - Raydium: 4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R - wSOL: So11111111111111111111111111111111111111112 - ATLAS: ATLASXmbPQxBUYbxPsV97usA3fPQYEqzQBUHgiFCUsXx
 */
...
data class BalanceRequest (
    ...
    @Json(name = "unit")
    val unit: BalanceRequest.Unit? = Unit.lamport,

    @Json(name = "network")
    val network: BalanceRequest.Network? = Network.devnet,
    ...
    enum class Unit(val value: kotlin.String) {
        @Json(name = "lamport") lamport("lamport"),
