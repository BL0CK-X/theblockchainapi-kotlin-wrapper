...
data class ListTokensRequest (

    /* Whether or not to include NFTs in the response */
    @Json(name = "include_nfts")
    val includeNfts: kotlin.Boolean? = false,
    ...
    @Json(name = "include_zero_balance_holdings")
    val includeZeroBalanceHoldings: kotlin.Boolean? = false
