...
data class UploadFileRequest (
    ...
    val uploadMethod: UploadFileRequest.UploadMethod? = UploadMethod.iPFS
     ...
     * 
     *
     * Values: iPFS,arweave,filecoin
     */
    enum class UploadMethod(val value: kotlin.String) {
        @Json(name = "IPFS") iPFS("IPFS"),
        @Json(name = "Arweave") arweave("Arweave"),
        @Json(name = "Filecoin") filecoin("Filecoin");
    }
}
