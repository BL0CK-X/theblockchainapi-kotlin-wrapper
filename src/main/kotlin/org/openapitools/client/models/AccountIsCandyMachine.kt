 ...
 * 
 *
 * @param isCandyMachine 
 * @param candyMachineContractVersion Whether or not this corresponds to candy machine v1, candy machine v2, or a Magic Eden candy machine.
 */

data class AccountIsCandyMachine (

    @Json(name = "is_candy_machine")
    val isCandyMachine: kotlin.Boolean,
    ...
    val candyMachineContractVersion: AccountIsCandyMachine.CandyMachineContractVersion? = null
     ...
     * Whether or not this corresponds to candy machine v1, candy machine v2, or a Magic Eden candy machine.
     *
     * Values: v1,v2,magicMinusEdenMinusV1
     */
    enum class CandyMachineContractVersion(val value: kotlin.String) {
        @Json(name = "v1") v1("v1"),
        @Json(name = "v2") v2("v2"),
        @Json(name = "magic-eden-v1") magicMinusEdenMinusV1("magic-eden-v1");
    }
}
