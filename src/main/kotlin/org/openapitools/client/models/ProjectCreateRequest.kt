 ...
 *
 * @param projectName The name of the mini-API. This will be shown at the top of the mini-API's documentation. 
 * @param projectDescription The description of the mini-API. This will be shown at the top of the mini-API's documentation, below the title. 
 * @param contactEmail The email where users of your mini-API can contact you. This will be shown at the top of the mini-API's documentation. 
 * @param groups A list of groups. A section contains groups, and groups contain API endpoints.  
 */
...
data class ProjectCreateRequest (
    ...
    val projectDescription: kotlin.String? = null,
