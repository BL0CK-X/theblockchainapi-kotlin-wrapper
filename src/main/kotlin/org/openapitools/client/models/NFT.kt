 ...
 * 
 *
 * @param confirmed Whether or not the NFT mint was confirmed or simply submitted for processing. The status depends on your input for `wait_for_confirmation`. This only is returned when you are minting an NFT, not when searching or retrieving the metadata.
 * @param `data` 
 * @param isMutable 
 * @param mint The public key address of the NFT 
 * @param primarySaleHappened 
 * @param updateAuthority A public key address that is usually that of the person who minted the NFT 
...
data class NFT (
    ...
    @Json(name = "primary_sale_happened")
    val primarySaleHappened: kotlin.Boolean? = null,
    ...
    @Json(name = "mint_secret_recovery_phrase")
