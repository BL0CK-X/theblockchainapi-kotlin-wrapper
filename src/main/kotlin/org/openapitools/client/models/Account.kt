...
import org.openapitools.client.models.AccountContext
import org.openapitools.client.models.AccountValue
...
data class Account (
    ...
    @Json(name = "context")
    val context: AccountContext? = null,

    @Json(name = "value")
    val `value`: AccountValue? = null
