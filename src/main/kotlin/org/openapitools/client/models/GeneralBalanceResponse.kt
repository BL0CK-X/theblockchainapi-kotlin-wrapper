 ...
 * @param integerBalance Not included if retreiving native token (e.g., SOL, ETH, BNB, etc.) balance 
 * @param decimals Not included if retreiving native token (e.g., SOL, ETH, BNB, etc.) balance. 
 * @param unit Not included if retreiving a token / NFT balance 
 */

data class GeneralBalanceResponse (
