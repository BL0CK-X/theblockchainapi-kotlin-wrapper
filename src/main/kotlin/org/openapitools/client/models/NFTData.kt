 ...
 * 
 *
 * @param creators The creators of the NFT 
 * @param name The name of the NFT 
 * @param share The portion of the seller fee that each creator receives. Index 0 corresponds to creator at index 0 in the creator array, and so on. Length of share array must be the same as the length of the creator array. 
 * @param symbol The symbol of the NFT 
 * @param uri The URI of the NFT 
 * @param verified Whether or not the respective creator has signed the minting transaction of the NFT. Index 0 corresponds to creator at index 0 in the creator array, and so on. Length of verified array must be the same as the length of the creator array. 
 */
...
data class NFTData (
    ...
    @Json(name = "creators")
    val creators: kotlin.collections.List<kotlin.String>? = null,
    ...
    @Json(name = "share")
    val share: kotlin.collections.List<kotlin.Float>? = null,
    ...
    @Json(name = "verified")
    val verified: kotlin.collections.List<kotlin.Int>? = null
