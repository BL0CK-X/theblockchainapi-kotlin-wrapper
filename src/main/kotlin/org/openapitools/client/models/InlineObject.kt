 ...
 * 
 *
 * @param platform The platform for which the binary was compiled. Note that Darwin = Mac.
 */
...
data class InlineObject (
    ...
    @Json(name = "platform")
    val platform: InlineObject.Platform? = null
    ...
    enum class Platform(val value: kotlin.String) {
        @Json(name = "Darwin") darwin("Darwin"),
